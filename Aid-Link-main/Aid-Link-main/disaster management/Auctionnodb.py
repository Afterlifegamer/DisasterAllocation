...
users = {1: {"id": 1, "username": "john_doe", "email": "john@example.com"}}
materials = {1: {"id": 1, "name": "Recycled Bricks", "description": "High-quality bricks", "location": "NY", "seller_id": 1}}
auctions = {}
bids = {}
...
def create_auction():
    ...
    return render_template('create_auction.html', materials=materials)
...
def place_bid(auction_id):
    ...
    if amount < auctions[auction_id]['current_price']:
        bid_id = len(bids) + 1
        bids[bid_id] = {"id": bid_id, "auction_id": auction_id, "bidder_id": bidder_id, "amount": amount}
        auctions[auction_id]['current_price'] = amount
        flash('Bid placed successfully!')
    else:
        flash('Bid must be higher than the current price.')
